...
/* multer storage removed */
/* multer upload removed */

// Create uploads directory if not exists
// fs omitted (serverless)
if (!false) {
    ;
}
...
app.get('/api/admin/buildings', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/health/db', async (c) => {
  ...
  if (req.files.length > 0) {
    ...
    try {
        const dbType = c.env.DATABASE_URL ? 'PostgreSQL' : 'SQLite';
        let result;
        ...
        res.json({
            ...
            dbType,
            connection: result,
            env_db_url_configured: !!c.env.DATABASE_URL
        });
    } catch (error) {
        ...
        res.status(500).json({
            ...
            dbType: c.env.DATABASE_URL ? 'PostgreSQL' : 'SQLite'
        });
    }
});

// 25. Search Building by Address Snippet (Moved up for priority)
app.get('/api/buildings/search-by-address', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/info/stats', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/landlord/:id/vacant-postings', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
            ...
            db.run(query, [finalRelId, targetTable, title, description, finalPrice, finalCreatedBy, finalTargetId, category || null, is_anonymous ? 1 : 0], function (err) {
                ...
                const insertPhotos = (idx, callback) => {
                    ...
                    db.run(`INSERT INTO images(related_id, image_url, is_main, related_table) VALUES(?, ?, ?, ?)`,
                        [adId, (uploadedUrls[idx] || '/placeholder.png'), idx === 0 ? 1 : 0, 'advertisements'],
                        (err) => {
...
app.put('/api/postings/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
            ...
            const finalizeUpdate = () => {
                ...
                db.run(query, [title, description, finalPrice, finalTargetId, category || null, is_anonymous ? 1 : 0, finalRelatedId, type || ad.related_table, adId], function (err) {
                    ...
                    const insertPhotos = (idx, callback) => {
                        ...
                        const file = photos[idx];
                        db.run(`INSERT INTO images(related_id, image_url, is_main, related_table) VALUES(?, ?, ?, ?)`,
                            [adId, (uploadedUrls[idx] || '/placeholder.png'), 0, 'advertisements'],
                            (err) => {
...
app.delete('/api/postings/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/postings/:id/applicants', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/postings/:id/select-winner', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/postings/:id/apply', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/postings/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/items/:id/history', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/postings/:id/redeploy', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/config/kakao', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
  ...
  if (req.files.length > 0) {
    ...
    res.json({ kakaoKey: c.env.KAKAO_JS_KEY });
});

app.get('/api/config/mode', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/messages/direct', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.put('/api/profile/:id', async (c) => {
  ...
  if (req.files.length > 0) {
    ...
    const photo_path = req.file ? (uploadedUrls[0] || '/placeholder.png') : null;
...
app.get('/api/landlord/:id/tenants', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/tenant/:id/billing', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/match-payment', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/contract/:id/unmatched-payments', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
// 8. Contracts list
app.get('/api/contracts/list', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/contract/:id/full-details', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/tenant/:id/calendar-data', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/landlord/:id/calendar-data', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/admin/calendar-data', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/payments/ledger', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/invoices/adjust-date', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/landlord/:id/contracts/active', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/tenants/active-list', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/contracts/:id/keyword', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/payments/batch', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/landlord/:id/buildings', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/tenant/:id/buildings', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/buildings/:id/addresses', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/buildings/:id/addresses', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.delete('/api/buildings/:id/addresses', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/users/find', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/users/quick', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/contracts/:id/terminate', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
// 24a. Create Contract
app.post('/api/contracts/full', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/contracts/:id/reset', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/buildings/:id/rooms-with-events', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/room-events/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/rooms/:id/events', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
  ...
  if (req.files.length > 0) {
    ...
    const photo = req.file ? (uploadedUrls[0] || '/placeholder.png') : null;
...
app.put('/api/room-events/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
  ...
  if (req.files.length > 0) {
    ...
    if (req.file) {
        query += `, photo = ? `;
        params.push((uploadedUrls[0] || '/placeholder.png'));
    }
...
app.delete('/api/room-events/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/rooms/:id/tenants', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
// 31b. Get Message Recipients Status
app.get('/api/message-recipients/:id', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.put('/api/notices/:id/confirm', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.post('/api/rooms/:id/status', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
...
app.get('/api/admin/export-db', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
  ...
  if (req.files.length > 0) {
    ...
    if (!false) return res.status(404).json({ error: 'DB file not found' });
    res.download(dbPath, 'sugar_backup.db');
});

app.post('/api/admin/import-db', async (c) => {
  const req = {
    query: c.req.query(),
    params: c.req.param(),
    body: {}, 
  ...
  if (req.files.length > 0) {
    ...
    try {
        ...
        throw new Error('FileSystem operations not supported on Workers');
